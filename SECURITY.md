...
Use [GitHub's private vulnerability reporting](https://github.com/chachasmooth/Encore/security/advisories/new),
...
Encore is worth thinking about carefully, because of what it handles:
...
Encore does not phone home, collect analytics, or make outbound network
connections other than to a client Mac you have paired with.

## Out of scope

- The fact that Encore relies on undocumented Apple API. This is a known,
